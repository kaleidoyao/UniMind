...
def main(args):
    ...
    # ]
    datasets_train = [
        ["/home/bingxing2/ailab/wangjunyu/LaBraM/LaBraM-main/dataset/motor/competition/dataset.hdf5"], # e.g., 22 channels for dataset1 and dataset2
    ]
    ...
    # ]
    time_window = [
        11, # set the time window to 11 so that the sequence length is 11 * 22 = 242
    ]
